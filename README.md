...
Document Restoration Viewer/Editor — a frontend tool for visually verifying and correcting OCR results from damaged document restoration.
...
- **Comparison Mode** — before/after slider comparing original vs restored pages with zoom/pan
